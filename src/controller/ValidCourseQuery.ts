...
export default class CourseQueryValid extends QueryValid {
    ...
    constructor() {
        ...
        super();
        this.sfields = ["dept", "id", "instructor", "title", "uuid"];
        this.mfields = ["avg", "pass", "fail", "audit", "year"];
        Log.trace("isCourseQueryValid::init()");
    }
